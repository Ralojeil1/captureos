...
def _setup_google_oauth():
    ...
    print()
    print("This uses Google's official OAuth client. It may show a")
    print("'Google hasn't verified this app' warning. This is NORMAL")
    print("for developer tools — just click 'Advanced' → 'Go to unsafe'.")
    print()
    print("This is ONLY for your own Google account. There is zero risk.")
    print()
